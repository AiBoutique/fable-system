...
- **Phase 4 — portability (DONE except live cross-model):** portable core extracted to `core/portable-core.md` (11.9 KB, zero platform-specific tokens); Grok/OpenAI adapters implemented (dry-run verified; live runs await user-supplied keys); portable core re-measured on Claude — §7.
