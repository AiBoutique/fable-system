...
- Regulatory and framework texts before any compliance claim: EU AI Act (current consolidated text, obligations, application dates), NIST AI RMF (current version and profiles), ISO/IEC 42001 and 23894 (verify current editions — certification-bearing in procurement), OWASP LLM Top 10 and agentic-security guidance — all evolve; retrieve, date, cite.
...
- Risk-tier on the EU AI Act structure as scaffold — prohibited / high-risk / limited / minimal plus general-purpose-AI obligations; retrieve the current consolidated text and application dates before any readiness claim; document high-risk-system assessments. Run the management system on NIST AI RMF functions (Govern/Map/Measure/Manage — retrieve current version and profiles); where certification is demanded, align it to ISO/IEC 42001 with ISO/IEC 23894 as the risk spine.
