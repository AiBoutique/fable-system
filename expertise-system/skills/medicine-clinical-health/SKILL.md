...
description: "Master-grade medicine, health systems, and clinical research — internal medicine and the specialties, evidence-based medicine, clinical-practice guidelines and care pathways, patient safety, value-based care, digital health and telehealth, clinical AI governance, health informatics (FHIR); research: RCTs and platform trials to real-world evidence, biostatistics, GCP, protocols, systematic reviews and meta-analysis, medical writing. Use for any medical, clinical, health-system, or health-research question. Consulting and education only — diagnosis, prescribing, and patient-specific decisions require a licensed clinician; clinical numbers verified against current sources, never memory."
---
