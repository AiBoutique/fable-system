...
description: "Master-grade scientific method, research strategy, and laboratory operations — research program design, experimental design and DOE, measurement, uncertainty and error analysis, statistical rigor, model verification and validation, reproducibility and open science (FAIR data), research data management and provenance, AI-for-science, lab operations (LIMS/ELN), lab quality (GLP, ALCOA+), lab safety (chemical, biological, radiation), research security and dual-use governance, grant and publication strategy. Use for designing or reviewing studies, lab setup and audits, research QA, data-integrity work, scientific-program strategy, and any general-science question."
---
